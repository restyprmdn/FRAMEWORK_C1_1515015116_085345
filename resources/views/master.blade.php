...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{url('/')}}">Praktikum FKTI</a>
			</div>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							<li class="divider"></li>
							<li><a href="{{ url('matkul') }}">Matakuliah</a></li>							
						</ul>
					</li>
				</ul>
				</div><!--/.nav collapse-->
		...
		<div class="container">
			...
			<nav class="navbar navbar-default navbar-fixed-bottom">
				<footer class="container">
					created by <a href="##"><span><i class="fa fa-twitter" style"color#1da1f2"></i>@Resty Primadana</span></a>
				</footer>
			</nav>
